    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 container-custom section-padding">
        <div className="relative animate-slide-up text-center max-w-4xl mx-auto">
          ...
          {/* Main heading */}
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-display font-black tracking-tight leading-none mb-3">
          ...
          {/* Subheadline */}
          <p className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2 tracking-tight">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 via-pink-300 to-purple-300">
              Unforgettable Bachelorette Weekends
            </span>
          </p>
          {/* Shimmer underline */}
          <div className="mx-auto w-64 h-2 rounded-full bg-gradient-to-r from-brand-primary via-brand-accent to-brand-secondary mb-6 animate-gradient-shimmer shadow-glow" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button
              className="bg-gradient-to-r from-brand-primary to-brand-accent inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full text-white font-bold transition-all min-w-[220px] transform hover:scale-105 shadow-glow hover:shadow-glow-lg"
            ...
            <button
              className="bg-gradient-to-r from-brand-secondary to-teal-400 inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full text-white font-bold transition-all min-w-[220px] transform hover:scale-105 shadow-glow hover:shadow-glow-lg"
